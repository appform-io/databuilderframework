...
import io.appform.databuilderframework.engine.impl.MixedDataBuilderFactory;
...
/**
 * Build {@link io.appform.databuilderframework.model.DataFlow} for execution by the {@link io.appform.databuilderframework.engine.DataFlowExecutor}.
 * A {@link io.appform.databuilderframework.model.DataFlow} needs to be calculated based on the target
 * {@link io.appform.databuilderframework.model.Data} that needs to be generated. DataFlowBuilder uses the registered
 * {@link io.appform.databuilderframework.engine.DataBuilder} classes or instances to find out the {@link io.appform.databuilderframework.model.ExecutionGraph}.
 * The execution graph is generated based on the "produces" and "consumes" spec on a builder. This information can be
 * extracted from the {@link io.appform.databuilderframework.annotations.DataBuilderInfo} or {@link io.appform.databuilderframework.annotations.DataBuilderClassInfo} annotations
